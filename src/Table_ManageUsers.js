  ...
  console.log(enhancedArray);
   const Row = ({ record }) => {
        ...
        return (
          <>
           <TableRow >
            <TableCell style={{fontSize:'18px'}}>{record.batteryId}</TableCell>
            ...
            <TableCell style={{fontSize:'18px'}}>{record.serviceEngineer}</TableCell>
        ...
        <TableContainer component={Paper} sx={{m:1,bgcolor:'white',maxWidth:'99%',mt:10}}>
          <Table>
              <TableRow>
                ...
                <TableCell><h4>SE_Name</h4></TableCell>
